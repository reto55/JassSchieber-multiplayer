...
title: _basic_state
resource: tests/multiplayer/test_ai_pimc.py#L40-L51
visibility: private
generated:
  by: okf-rs/0.3.0
relationships:
...
`def _basic_state(my_hand, others, hand_sizes, voids=None, no_trump_except_under=None, unseen=None, operator="Schellen", me="comps"):`
